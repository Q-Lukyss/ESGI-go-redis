...
// ParseCommand transforme une ligne de commande texte en Command.
// Elle ne touche à aucun état : c'est une simple transformation de texte.
...
// Le piège classique : un découpage naïf sur les espaces casse les valeurs
// contenant des espaces. On construit donc les tokens caractère par caractère.
